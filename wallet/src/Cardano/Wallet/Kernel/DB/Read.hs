...
rootTotalBalance :: DB -> HdRootId -> CoinPair
...
currentTotalBalance :: DB -> HdAccountId -> Either UnknownHdAccount CoinPair
currentTotalBalance = liftHd1 HD.currentTotalBalance

currentAvailableBalance :: DB -> HdAccountId -> Either UnknownHdAccount CoinPair
