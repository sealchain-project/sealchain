...
data Checkpoint = Checkpoint {
    ...
    , _checkpointUtxoBalance :: !(InDb Core.CoinPair)
...
initCheckpoint utxo = Checkpoint {
    ...
    , _checkpointUtxoBalance = InDb $ Core.unsafeUtxoBalance utxo
...
data PartialCheckpoint = PartialCheckpoint {
    ...
    , _pcheckpointUtxoBalance :: !(InDb Core.CoinPair)
...
initPartialCheckpoint ctx utxo = PartialCheckpoint {
    ...
    , _pcheckpointUtxoBalance = InDb $ Core.unsafeUtxoBalance utxo
...
class IsCheckpoint c where
    ...
    cpUtxoBalance :: Lens' c Core.CoinPair
...
currentUtxoBalance :: IsCheckpoint c => Lens' (Checkpoints c) Core.CoinPair
