...
import           Pos.Core (Address, CoinPair, SlotCount, SlotId, Timestamp,
...
metaToTx db slotCount current TxMeta{..} = do
    ...
    return V1.Transaction {
        ...
        where
            ...
            inputsToPayDistr :: (a , b, Address, CoinPair) -> V1.PaymentDistribution
            inputsToPayDistr (_, _, addr, c) = V1.PaymentDistribution (V1 addr) (V1 c)

            outputsToPayDistr :: (Address, CoinPair) -> V1.PaymentDistribution
